...
Transaction.MAX_MONEY = 300000000 * 1e8; // Lipcoin has 300M coins
...
Transaction.FEE_PER_KB = 1000000; // Lipcoin default fees is 0.001 LTC
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://lipcore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by lipcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a lipcore Address object. The
 * same is true for `script`, which can be a string or a lipcore Script.
 *
